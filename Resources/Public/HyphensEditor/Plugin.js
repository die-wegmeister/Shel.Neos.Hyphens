...
var ShyCommand = function (_Command) {
    _inherits(ShyCommand, _Command);

    function ShyCommand() {
        _classCallCheck(this, ShyCommand);

        return _possibleConstructorReturn(this, (ShyCommand.__proto__ || Object.getPrototypeOf(ShyCommand)).apply(this, arguments));
    }

    _createClass(ShyCommand, [{
        key: 'execute',
        value: function execute() {
            ...
            editor.model.change(function (writer) {
                ...
                writer.insertText('\xAD', insertPosition);
            });
        }
    }]);
...
exports.default = ShyCommand;

/***/ }),

/***/ "./src/hyphensButtonTheme.css":
/*!************************************!*\
  !*** ./src/hyphensButtonTheme.css ***!
  \************************************/
/*! no static exports found */
...
module.exports = {"btn--no-padding":"hyphensButtonTheme__btn--no-padding___3nhbe"};
...
var _hyphens = __webpack_require__(/*! ./plugins/hyphens */ "./src/plugins/hyphens.js");

var _hyphens2 = _interopRequireDefault(_hyphens);
...
exports.default = function (ckEditorRegistry) {
    var config = ckEditorRegistry.get('config');

    config.set('hyphens', addPlugin(_hyphens2.default, (0, _plowJs.$get)('hyphens')));
...
var _manifest = __webpack_require__(/*! ./manifest.richtextToolbar */ "./src/manifest.richtextToolbar.js");

var _manifest2 = _interopRequireDefault(_manifest);

var _manifest3 = __webpack_require__(/*! ./manifest.config */ "./src/manifest.config.js");

var _manifest4 = _interopRequireDefault(_manifest3);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _neosUiExtensibility2.default)('Shel.Neos:HyphenEditor', {}, function (globalRegistry) {
    var ckEditorRegistry = globalRegistry.get('ckEditor5');

    (0, _manifest2.default)(ckEditorRegistry);
    (0, _manifest4.default)(ckEditorRegistry);
});

/***/ }),

/***/ "./src/manifest.richtextToolbar.js":
/*!*****************************************!*\
  !*** ./src/manifest.richtextToolbar.js ***!
  \*****************************************/
/*! no static exports found */
...
var _hyphensButtonTheme = __webpack_require__(/*! ./hyphensButtonTheme.css */ "./src/hyphensButtonTheme.css");

var _hyphensButtonTheme2 = _interopRequireDefault(_hyphensButtonTheme);
...
var ButtonComponent = (_dec = (0, _neosUiDecorators.neos)(function (globalRegistry) {
    return {
        i18nRegistry: globalRegistry.get('i18n')
    };
}), _dec2 = (0, _reactCssThemr.themr)('HyphensButton', _hyphensButtonTheme2.default), _dec(_class = _dec2(_class = (_temp = _class2 = function (_PureComponent) {
    ...
    _createClass(ButtonComponent, [{
        ...
        value: function render() {
            var finalProps = (0, _lodash2.default)(this.props, ['formattingRule', 'inlineEditorOptions', 'i18nRegistry', 'tooltip', 'isActive', 'label']);
            return _react2.default.createElement(
                _reactUiComponents.Button,
                _extends({}, finalProps, { isActive: Boolean(this.props.isActive),
                    className: _hyphensButtonTheme2.default['btn--no-padding'],
                    title: this.props.i18nRegistry.translate(this.props.tooltip) }),
                _react2.default.createElement(
                    'svg',
                    { xmlns: 'http://www.w3.org/2000/svg', width: '18.109', height: '9.697', viewBox: '0, 0, 18.109, 9.697' },
                    _react2.default.createElement(
                        'g',
                        { stroke: 'currentColor', strokeMiterlimit: '3.864', fill: 'none' },
                        _react2.default.createElement('path', { d: 'M2.596 1a5.44 5.44 0 0 0 0 7.697m12.918 0a5.44 5.44 0 0 0 0-7.697',
                            strokeWidth: '.907' }),
                        _react2.default.createElement('path', { d: 'M4.52 4.848h9.07', strokeWidth: '1.814' })
                    )
                )
            );
        }
...
exports.default = function (ckEditorRegistry) {
    ...
    richtextToolbar.set('shy', {
        ...
        isVisible: (0, _plowJs.$get)('hyphens'),
        isActive: (0, _plowJs.$get)('shy')
    });
...
var _shy = __webpack_require__(/*! ../commands/shy */ "./src/commands/shy.js");

var _shy2 = _interopRequireDefault(_shy);

var _hyphens = __webpack_require__(/*! ./hyphens.vanilla-css */ "./src/plugins/hyphens.vanilla-css");
...
var softHyphenCharacter = '\xAD';

var Hyphens = function (_Plugin) {
    _inherits(Hyphens, _Plugin);

    function Hyphens() {
        _classCallCheck(this, Hyphens);

        return _possibleConstructorReturn(this, (Hyphens.__proto__ || Object.getPrototypeOf(Hyphens)).apply(this, arguments));
    }

    _createClass(Hyphens, [{
        key: 'init',
        value: function init() {
            var editor = this.editor;


            editor.commands.add('insertShyEntity', new _shy2.default(editor));

            editor.conversion.for('editingDowncast').add(function (dispatcher) {
                dispatcher.on('insert:$text', function (evt, data, conversionApi) {
                    ...
                    var modelPosition = data.range.start;
                    var viewPosition = conversionApi.mapper.toViewPosition(modelPosition);

                    var dataChunks = data.item.data.split(softHyphenCharacter);
                    for (var i = 0; i < dataChunks.length; i++) {
                        ...
                        var viewSpaceSpan = viewWriter.createAttributeElement('span', { class: 'shy' });
                        var modelWrapRange = new _ckeditor5Exports.ViewRange(modelPosition, modelPosition.getShiftedBy(1));
                        var viewWrapRange = conversionApi.mapper.toViewRange(modelWrapRange);
...
exports.default = Hyphens;

/***/ }),

/***/ "./src/plugins/hyphens.vanilla-css":
/*!*****************************************!*\
  !*** ./src/plugins/hyphens.vanilla-css ***!
  \*****************************************/
/*! no static exports found */
